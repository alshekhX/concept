...
const WhoUs = () => {
   ...
   const t= useTranslations('HomePage.WhoUs')
  return (
    <div className="container mx-auto px-6 sm:px-4 py-20 md:py-32 flex flex-col">
      ...
      />
      <HomeSubtitle title={t('subtitleText')} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-4">
            <Image
              src={Show1}
              alt=          {t('imageAlt.show1')}
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
            <Image
              src={Show2}
              alt=          {t('imageAlt.show2')}
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
          </div>
          <div className="flex flex-col gap-4">
            <Image
              src={Show3}
              alt=          {t('imageAlt.show3')}
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
            <Image
              src={Show4}
              alt=          {t('imageAlt.show4')}
              className="w-full h-full object-cover rounded-lg shadow-lg"
            />
          </div>
        </div>
