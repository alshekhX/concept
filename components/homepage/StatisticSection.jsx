...
const StatisticSection = () => {
    ...
    return (
        ...
        <DividerTitle title='Statistics'  dividerWidth={'90px'} textColor='text-lightBejj' dividerColor='bg-white opacity-85'/>
        <HomeSubtitle title='Experience You Can Trust' style=' text-lightBejj'/>
