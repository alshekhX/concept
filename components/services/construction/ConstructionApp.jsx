    ...
    <div className="py-32 px-4 container mx-auto">
      ...
      <div className=" my-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-gray-700 text-2xl lg:w-4/5 text-justify leading-relaxed">
          ...
          <p className="text-gray-800 text-xl font-semibold lg:w-4/5 italic border-l-4 border-darkBlue pl-4">
