...
const ContactHero = () => {
    return (
      ...
      whileInView={{ opacity: 1, y: 0 }}   transition={{ delay: 0,duration:.3}}  className="  z-10 md:text-6xl xl:text-8xl text-7xl mb-4 font-bold text-white">Contact Us</AnimateH1>
