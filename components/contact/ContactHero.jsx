...
const ContactHero = () => {
    return (
      ...
      whileInView={{ opacity: 1, y: 0 }}   transition={{ delay: 0,duration:.3}}  className="  z-10 md:text-6xl xl:text-8xl text-6xl sm:text-7xl mb-4 font-bold text-white">Contact Us</AnimateH1>
      <AnimateH2  initial={{ opacity: 0, y: -20 }}
      whileInView={{ opacity: 1, y: 0 }}   transition={{ delay: .3,duration:.3}}  className="  md:w-2/5 w-4/5 z-10 xl:text-3xl md:text-2xl text-2xl  text-white">Have a specific inquiry or need assistance? Our dedicated team is ready to provide expert guidance and support. Contact us today to discuss your requirements.</AnimateH2>
    </div>
